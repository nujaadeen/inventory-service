...
public record BatchRequest(
        Long grnId,
        @NotBlank(message = "Product SKU is required") String productSku,
        ...
        @NotNull @Positive(message = "Cost price must be positive") BigDecimal costPrice,
        ...
        @NotEmpty(message = "At least one price type must be defined") @Valid
